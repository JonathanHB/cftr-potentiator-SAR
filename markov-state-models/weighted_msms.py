...
#    this should be the same as pyem.active_set

def transitions_2_msm(transitions, weights):
    ...
    for tr, w in zip(transitions, weights):
        if tr[0] in states_in_order and tr[1] in states_in_order:
            transition_counts[state_to_ind[tr[1]]][state_to_ind[tr[0]]] += w
